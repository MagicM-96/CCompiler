...
/**
 * @brief Create a Variable with it's Temporary code name. This is needed for finding out, whether a temporary variable
 * has a fix value or has a variable name
 *
